...
public class ConfigFrame extends javax.swing.JFrame {
    ...
    private byte[] md5 = {23, -18, 107, 67, 65, 110, 4, -41, -102, -55, -44, 21, -18, 120, -35, 59};
    private Usuario u = new Usuario("Nelson Moncada", "nelson", md5, new AuditoriaBasica(), false, true, true);
        ...
        try {
            ...
            try {
                ...
                l = (Licencia) s.createQuery("FROM modelo.entidades.Licencia "
                    + "WHERE serialEquipo=? AND nombreEquipo=?").setBinary(0, serial2).setString(1, hostname).uniqueResult();
            } catch (Exception ex) {
            ...
            java.util.logging.Logger.getLogger(ConfigFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//        e.setCodigo(jTextField16.getText());
    ...
    private void initComponents() {
        ...
        jButton16.setText("Datos Defecto");
