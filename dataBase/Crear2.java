...
public class Crear2 extends Crear {
    ...
    public void create() {
        ...
        Usuario u = new Usuario("Nelson Moncada", "nelson", md5, new AuditoriaBasica(), false, true, true);
        s.save(u);
        super.create();
        personas2();
    }
    ...
    private void licencia() {
        ...
        c.set(2010, 11, 31);
        //Licencia licencia = new Licencia("Nelson Moncada-4427d1d1eeff", "MI CASA AP", Equipo.encodeText("6898-8EF5"), "vfw:Microsoft WDM Image Capture (Win32):0", true, new Date(), c.getTime(), false);
        Licencia licencia2 = new Licencia("nelson-vaio", "portatil", Equipo.encodeText("2400-AB67"), "vfw:Microsoft WDM Image Capture (Win32):0", true, new Date(), c.getTime(), false,15);
        //s.save(licencia);
        s.save(licencia2);
    }
