...
import modelo.entidades.polizas.recibos.maestra.TipoFianza;
import modelo.entidades.siniestros.dominio.GrupoRecaudo;
import modelo.entidades.siniestros.dominio.Recaudo;
import modelo.entidades.siniestros.dominio.TipoNotificacion;
...
public class Crear {
    ...
    protected TipoPersona tpEjecutivo;
...
//        close();
//        abrir();
        tipoBienAsegurado(auditoriaActivo);
//        close();
//        abrir();
        tiposDocumento(auditoriaActivo);
//        close();
//        abrir();
//        tiposNotificacion(auditoriaActivo);

//        close();
//        abrir();
        tiposDireccion(auditoriaActivo);

        tiposFianza(auditoriaActivo);
...
//        abrir();
    ...
    private void recaudos(AuditoriaBasica a) {
        ArrayList<GrupoRecaudo> list = new ArrayList<GrupoRecaudo>(0);

        GrupoRecaudo r1= new GrupoRecaudo("DOCUMENTOS POR REEMBOLSO",Dominios.RamoContable.PERSONA, auditoriaActivo);
        Recaudo rr1=new Recaudo("FACTURAS ORIGINALES DE CONSULTA", auditoriaActivo);
        r1.getDetalleRecaudos().add(rr1);
        rr1.setRecaudo(r1);
        Recaudo rr2 = new Recaudo("INFORME AMPLIO Y DETALLADO DE CONSULTA", auditoriaActivo);
        r1.getDetalleRecaudos().add(rr2);
        rr2.setRecaudo(r1);
        Recaudo rr3=new Recaudo("FACTURAS ORIGINALES DE FARMACIA", auditoriaActivo);
        r1.getDetalleRecaudos().add(rr3);
        rr3.setRecaudo(r1);
        Recaudo rr4= new Recaudo("RECIPES MEDICOS", auditoriaActivo);
        r1.getDetalleRecaudos().add(rr4);
        rr4.setRecaudo(r1);
        Recaudo rr5=new Recaudo("FACTURAS ORIGINALS DE ESTUDIOS REALIZADOS", auditoriaActivo);
        r1.getDetalleRecaudos().add(rr5);
        rr5.setRecaudo(r1);
        Recaudo rr6=new Recaudo("FACTURAS ORIGINALS DE ESTUDIOS REALIZADOS", auditoriaActivo);
        r1.getDetalleRecaudos().add(rr6);
        rr6.setRecaudo(r1);
        Recaudo rr7=new Recaudo("RESULTADOS DE ESTUDIOS REALIZADOS CON SUS INFORMES", auditoriaActivo);
        r1.getDetalleRecaudos().add(rr7);
        rr7.setRecaudo(r1);
        Recaudo rr8=new Recaudo("RADIOGRAFIAS", auditoriaActivo);
        r1.getDetalleRecaudos().add(rr8);
        rr8.setRecaudo(r1);
        Recaudo rr9=new Recaudo("EN CASO DE SER TRAUMATISMO O ACCIDENTE CARTA NARRATIVA DEL ASEGURADO", auditoriaActivo);
        r1.getDetalleRecaudos().add(rr9);
        rr9.setRecaudo(r1);
        list.add(r1);

        GrupoRecaudo r2= new GrupoRecaudo("DOCUMENTOS POR CARTA AVAL",Dominios.RamoContable.PERSONA, auditoriaActivo);
        Recaudo rrr1=new Recaudo("PRESUPUESTO DE CLINICA 1 INDIVIDUAL - 2 COLECTIVO", auditoriaActivo);
        r2.getDetalleRecaudos().add(rrr1);
        rrr1.setRecaudo(r2);
        Recaudo rrr2=new Recaudo("INFORME AMPLIO Y DETALLADO DEL MEDICO", auditoriaActivo);
        r2.getDetalleRecaudos().add(rrr2);
        rrr2.setRecaudo(r2);
        Recaudo rrr3=new Recaudo("ESTUDIOS REALIZADOS QUE CONFIRMEN EL DIAGNOSTICO", auditoriaActivo);
        r2.getDetalleRecaudos().add(rrr3);
        rrr3.setRecaudo(r2);
        Recaudo rrr4=new Recaudo("RADIOGRAFIAS (URETROCISTOSCOPIA)", auditoriaActivo);
        r2.getDetalleRecaudos().add(rrr4);
        rrr4.setRecaudo(r2);
        Recaudo rrr5=new Recaudo("EN CASO DE SER TRAUMATISMO O ACCIDENTE CARTA NARRATIVA DEL ASEGURADO", auditoriaActivo);
        r2.getDetalleRecaudos().add(rrr5);
        rrr5.setRecaudo(r2);
        list.add(r2);

        GrupoRecaudo r3= new GrupoRecaudo("SINIESTRO EN CASO DE PERDIDA O CHOQUE PARCIAL", Dominios.RamoContable.VEHICULO ,auditoriaActivo);
        Recaudo rrrr1=new Recaudo("DECLARACION DE SINIESTRO TOTALMENTE LLENA", auditoriaActivo);
        r3.getDetalleRecaudos().add(rrrr1);
        rrrr1.setRecaudo(r3);
        Recaudo rrrr2=new Recaudo("COPIA LEGIBLE DE CEDULA DE IDENTIDAD DEL CONDUCTOR DEL VEHICULO", auditoriaActivo);
        r3.getDetalleRecaudos().add(rrrr2);
        rrrr2.setRecaudo(r3);
        Recaudo rrrr3=new Recaudo("COPIA LEGIBLE DE CERTIFICADO MEDICO", auditoriaActivo);
        r3.getDetalleRecaudos().add(rrrr3);
        rrrr3.setRecaudo(r3);
        Recaudo rrrr4=new Recaudo("COPIA LEGIBLE DE LICENCIA DE CONDUCTOR", auditoriaActivo);
        r3.getDetalleRecaudos().add(rrrr4);
        rrrr4.setRecaudo(r3);
        Recaudo rrrr5=new Recaudo("COPIA DE LA POLIZA VIGENTE", auditoriaActivo);
        r3.getDetalleRecaudos().add(rrrr5);
        rrrr5.setRecaudo(r3);
        Recaudo rrrr6=new Recaudo("COPIA DEL DOCUMENTO DE PROPIEDAD DEL VEHICULO", auditoriaActivo);
        r3.getDetalleRecaudos().add(rrrr6);
        rrrr6.setRecaudo(r3);
        Recaudo rrrr7= new Recaudo("ORIGINAL EXPEDIENTE  Y ACTA DE AVALUO DE TRANSITO TERRESTRE (SI LO HAY)", auditoriaActivo);
        r3.getDetalleRecaudos().add(rrrr7);
        rrrr7.setRecaudo(r3);
        Recaudo rrrr8=new Recaudo("HOJA DE ASIGNACION DE TALLER AUTORIZADO", auditoriaActivo);
        r3.getDetalleRecaudos().add(rrrr8);
        rrrr8.setRecaudo(r3);
        Recaudo rrrr9=new Recaudo("FECHA DEL AJUSTE", auditoriaActivo);
        r3.getDetalleRecaudos().add(rrrr9);
        rrrr9.setRecaudo(r3);
        Recaudo rrrr10=new Recaudo("PRESUPUESTO", auditoriaActivo);
        r3.getDetalleRecaudos().add(rrrr10);
        rrrr10.setRecaudo(r3);
        list.add(r3);

        GrupoRecaudo r4= new GrupoRecaudo("DOCUMENTOS POR REEMBOLSO",Dominios.RamoContable.VEHICULO, auditoriaActivo);
        Recaudo b1=new Recaudo("FACTURAS ORIGINALES POR COMPRA DE REPUESTOS", auditoriaActivo);
        r4.getDetalleRecaudos().add(b1);
        b1.setRecaudo(r4);
        Recaudo b2=new Recaudo("FACTURAS ORIGINALES POR REPARACION DEL VEHICULO", auditoriaActivo);
        r4.getDetalleRecaudos().add(b2);
        b2.setRecaudo(r4);
        Recaudo b3=new Recaudo("FECHA LIMPIEZA DE DAÑOS", auditoriaActivo);
        r4.getDetalleRecaudos().add(b3);
        b3.setRecaudo(r4);
        list.add(r4);

        GrupoRecaudo r5= new GrupoRecaudo("SINIESTRO EN CASO DE ROBO O PERDIDA TOTAL",Dominios.RamoContable.VEHICULO, auditoriaActivo);
        Recaudo c1=new Recaudo("DECLARACION DE SINIESTRO TOTALMENTE LLENA", auditoriaActivo);
        r5.getDetalleRecaudos().add(c1);
        c1.setRecaudo(r5);
        Recaudo c2=new Recaudo("CARTA EXPLICATIVA DE LOS HECHOS FIRMADA POR EL ASEGURADO", auditoriaActivo);
        r5.getDetalleRecaudos().add(c2);
        c2.setRecaudo(r5);
        Recaudo c3=new Recaudo("ORIGINAL DENUNCIA DEL CICPC (CON DATOS COMPLETOS DEL VEHICULO)", auditoriaActivo);
        r5.getDetalleRecaudos().add(c3);
        c3.setRecaudo(r5);
        Recaudo c4=new Recaudo("ORIGINAL DENUNCIA ANTE TRANSITO TERRESTRE", auditoriaActivo);
        r5.getDetalleRecaudos().add(c4);
        c4.setRecaudo(r5);
        Recaudo c5=new Recaudo("COPIA VIGENTE Y LEGIBLE DE CEDULA Y/O RIF DEL PROPIETARIO Y CONDUCTOR", auditoriaActivo);
        r5.getDetalleRecaudos().add(c5);
        c5.setRecaudo(r5);
        Recaudo c6=new Recaudo("COPIA LEGIBLE DE CERTIFICADO MEDICO DEL CONDUCTOR", auditoriaActivo);
        r5.getDetalleRecaudos().add(c6);
        c6.setRecaudo(r5);
        Recaudo c7=new Recaudo("COPIA LEGIBLE DE LICENCIA DE CONDUCTOR", auditoriaActivo);
        r5.getDetalleRecaudos().add(c7);
        c7.setRecaudo(r5);
        Recaudo c8=new Recaudo("ORIGINAL DE LA POLIZA VIGENTE", auditoriaActivo);
        r5.getDetalleRecaudos().add(c8);
        c8.setRecaudo(r5);
        Recaudo c9=new Recaudo("ORIGINAL DEL TITULO DE PROPIEDAD DEL VEHICULO A NOMBRE DEL ASEGURADO", auditoriaActivo);
        r5.getDetalleRecaudos().add(c9);
        c9.setRecaudo(r5);
        Recaudo c10=new Recaudo("LLAVES ORIGINALES Y COPIA", auditoriaActivo);
        r5.getDetalleRecaudos().add(c10);
        c10.setRecaudo(r5);
        Recaudo c11=new Recaudo("LIBERACION DE RESERVA O CARTA DE SALDO DEUDOR DE LA ENTIDAD FINANCIERA", auditoriaActivo);
        r5.getDetalleRecaudos().add(c11);
        c11.setRecaudo(r5);
        Recaudo c12=new Recaudo("TRIMESTRES CANCELADOS", auditoriaActivo);
        r5.getDetalleRecaudos().add(c12);
        c12.setRecaudo(r5);
        Recaudo c13=new Recaudo("REGISTRO DE COMERCIO EN CASO DE SER EL PROPIETARIO PERSONA JURIDICA", auditoriaActivo);
        r5.getDetalleRecaudos().add(c13);
        c13.setRecaudo(r5);
        Recaudo c14=new Recaudo("COPIA LEGIBLE DE CEDULA DE IDENTIDAD DEL REPRESENTANTE LEGAL", auditoriaActivo);
        r5.getDetalleRecaudos().add(c14);
        c14.setRecaudo(r5);
        list.add(r5);

        GrupoRecaudo r6= new GrupoRecaudo("DOCUMENTOS",Dominios.RamoContable.PATRIMONIAL, auditoriaActivo);
        Recaudo d1=new Recaudo("DECLARACION FORMAL HECHA POR EL ASEGURADO EXPLICANDO LO OCURRIDO Y DETALLE DE LOS BIENES AFECTADOS", auditoriaActivo);
        r6.getDetalleRecaudos().add(d1);
        d1.setRecaudo(r6);
        list.add(r6);
...
//        list.add(new TipoCuentaBancaria("TARJETA DE CREDITO", a));
//        list.add(new TipoCuentaBancaria("TARJETA DE DEBITO", a));
        for (GrupoRecaudo o : list) {
            s.save(o);
        }
    }

    private void tipoBienAsegurado(AuditoriaBasica a)
    {
        ArrayList<TipoBienAsegurado> list = new ArrayList<TipoBienAsegurado>(0);
        list.add(new TipoBienAsegurado("PERSONAS", Dominios.RamoContable.PERSONA, a));
        list.add(new TipoBienAsegurado("VEHICULOS", Dominios.RamoContable.VEHICULO, a));
        list.add(new TipoBienAsegurado("FIANZA", Dominios.RamoContable.FIANZA, a));
        list.add(new TipoBienAsegurado("EDIFICACION", Dominios.RamoContable.PATRIMONIAL, a));
        list.add(new TipoBienAsegurado("MOBILIARIO", Dominios.RamoContable.PATRIMONIAL, a));
        list.add(new TipoBienAsegurado("MAQUINARIA", Dominios.RamoContable.PATRIMONIAL, a));
        list.add(new TipoBienAsegurado("EQUIPOS INDUSTRIALES", Dominios.RamoContable.PATRIMONIAL, a));
        for (TipoBienAsegurado o : list) {
            s.save(o);
        }
    }
    ...
    private void tiposNotificacion(AuditoriaBasica a) {
        ArrayList<TipoNotificacion> list = new ArrayList<TipoNotificacion>(0);
        list.add(new TipoNotificacion("Pagina Web", a));
        list.add(new TipoNotificacion("Correo Electronico", a));
        list.add(new TipoNotificacion("Carta", a));
        for (TipoNotificacion o : list) {
            s.save(o);
        }
    }
    ...
    private void tiposDireccion(AuditoriaBasica a) {
        ...
        list.add(dir);
        list.add(new TipoDireccion("RIESGO", a));
    ...
    private void tiposFianza(AuditoriaBasica a) {
        ArrayList<TipoFianza> list = new ArrayList<TipoFianza>(0);
        TipoFianza tipoFianza = new TipoFianza("COBRO", a);
        list.add(tipoFianza);
        list.add(new TipoFianza("RIESGO", a));
        list.add(new TipoFianza("PRINCIPAL", a));
        list.add(new TipoFianza("HABITACION", a));
        list.add(new TipoFianza("TRABAJO", a));
        list.add(new TipoFianza("SUCURSAL", a));
        for (TipoFianza o : list) {
            s.save(o);
        }
//        defaultData.persona.setDireccion(tipoFianza);
    }
    ...
    private void tiposRamoPoliza(AuditoriaBasica a) {
        ...
        list.add(new RamoPoliza("GASTOS FUNERARIOS INDINVIDUAL", "GTS. FUN. IND.", Dominios.TipoRamo.INDIVIDUAL, Dominios.RamoContable.PERSONA, a));
        ...
        list.add(new RamoPoliza("INCENDIO", "INCENDIO", Dominios.TipoRamo.INDIVIDUAL, Dominios.RamoContable.PATRIMONIAL, a));
        list.add(new RamoPoliza("ROBO", " ROBO", Dominios.TipoRamo.INDIVIDUAL, Dominios.RamoContable.PATRIMONIAL, a));
        ...
        list.add(new RamoPoliza("HOGAR", "HOGAR", Dominios.TipoRamo.INDIVIDUAL, Dominios.RamoContable.PATRIMONIAL, a));
        list.add(new RamoPoliza("TERREMOTO", "TERREMOTO", Dominios.TipoRamo.INDIVIDUAL, Dominios.RamoContable.PATRIMONIAL, a));
...
//        });
    ...
    private void tiposPersona(AuditoriaBasica a, AuditoriaBasica a2) {
        ...
        list.add(tpCobrador);
        tpEjecutivo=new TipoPersona("EJE", "EJECUTIVO", true, a);
        list.add(tpEjecutivo);
        list.add(new TipoPersona("IVA", "CONTRIBUYENTE", false, a2));
        list.add(new TipoPersona("RAZ", "RAZON SOCIAL", false, a));
