...
//                xxx.getItems().add(smsReciboPend);
            ...
            Item mantenimiento = new Item("Mantenimiento", null/*"advancedsettings.png"*/);
            {
                ...
                Item manRec = new Item("Recibos", null);
                {
                    ...
                    Item tipoBienAsegurado = new Item("Ramos - Coberturas",
                            "MAN", "menu/grupoPoliza.png", "getRamosCoberturas");
                    manRec.getItems().add(tipoBienAsegurado);
                    Item tipoBienAseg = new Item("Tipo de Bien Asegurado",
                            "MAN", "menu/grupoPoliza.png", "getTipoBienAsegurado");
                    manRec.getItems().add(tipoBienAseg);
                }
